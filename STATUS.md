...
- 阶段：v0.4.0 架构重构与 Java J2 中文全文搜索已完成，版本元数据进入发布候选验收
- 总体状态：J2 已合入受保护的 `main`，CI、CodeQL 与 Pages 全部成功；项目保持可发布
...
- Web 静态/API 两种适配器场景2/2通过；Java J3 26/26通过，JaCoCo 指令89.4%、分支74.1%，门禁通过。
