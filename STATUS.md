...
1. 完成 Python 大模块拆分并保持19项回归测试通过。
2. 迁移为 `apps/ + packages/ + workspace/` 单仓库结构。
3. 固化 Web/Java/未来 App 共用的数据与 HTTP 契约。
4. 完成上线构建与 App-ready 适配边界的总体验收。
